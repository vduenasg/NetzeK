...
void LCDsendChar(uint8_t);								//forms data ready to send to HD44780
void LCDsendCommand(uint8_t);							//forms data ready to send to HD44780
void LCDinit(void);										//Initializes LCD
void LCDclr(void);										//Clears LCD
void LCDhome(void);										//LCD cursor home					
void LCDstring(const char *s, uint8_t, uint8_t);		//Outputs string to LCD
